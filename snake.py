...
class snake:
    ...
    # dibuja la serpiente en la pantalla de pygame
    ...
    # retorna true si la serpiente esta viva caso contrario false
    def isAlive(self):
    ...
    # establece el crash_wall y crash_body si no puede ir al norte en consecuencia
    ...
    # mueve la serpiente en el norte
    def move_north(self):
        self.check_north()
    ...
    # establece el crash_wall y crash_body si no puede ir al sur en consecuencia
    ...
    # establece el crash_wall y crash_body si no puede ir al este en consecuencia
    def check_east(self):
    ...
    # establece el crash_wall y crash_body si no puede ir al oeste en consecuencia
    def check_west(self):
    ...
    # mueve la serpiente en el oeste
    def move_west(self):
        self.check_west()
        if not (self.crash_wall or self.crash_body):
            self.direction = 'west'
    ...
    # devuelve la siguiente posición y dirección de la cabeza según el resultado pasado
    ...
    # retorna true si x and y no se encuentra en el cuerpo de la serpiente
    def onBody(self, x, y):
    ...
    # aumentar el tamaño de la serpiente en la dirección dada por nn
    ...
    # Mueva la serpiente según el resultado proporcionado
